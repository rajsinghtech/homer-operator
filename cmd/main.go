...
func main() {
	...
	// Serving metrics securely with authn/authz filtering (instead of the
	// deprecated kube-rbac-proxy sidecar) requires this filter, which uses
	// TokenReview/SubjectAccessReview against the requester's bearer token.
